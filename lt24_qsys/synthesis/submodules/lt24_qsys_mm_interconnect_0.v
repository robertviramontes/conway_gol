...
// 
// Generated using ACDS version 14.1 186 at 2014.12.16.14:30:02

`timescale 1 ps / 1 ps
module lt24_qsys_mm_interconnect_0 (
		input  wire        alt_pll_outclk0_clk,                            //                          alt_pll_outclk0.clk
	...
	wire  [19:0] lt24_controller_0_avalon_slave_0_agent_m0_address;                                  // LT24_Controller_0_avalon_slave_0_agent:m0_address -> LT24_Controller_0_avalon_slave_0_translator:uav_address
	...
	wire  [98:0] lt24_controller_0_avalon_slave_0_agent_rf_source_data;                              // LT24_Controller_0_avalon_slave_0_agent:rf_source_data -> LT24_Controller_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [98:0] lt24_controller_0_avalon_slave_0_agent_rsp_fifo_out_data;                           // LT24_Controller_0_avalon_slave_0_agent_rsp_fifo:out_data -> LT24_Controller_0_avalon_slave_0_agent:rf_sink_data
	...
	wire         lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_valid;                        // LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_src_valid -> LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire  [33:0] lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_data;                         // LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_src_data -> LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_sink_data
	wire         lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_ready;                        // LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_sink_ready -> LT24_Controller_0_avalon_slave_0_agent:rdata_fifo_src_ready
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> LT24_Controller_0_avalon_slave_0_agent:cp_valid
	wire  [97:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> LT24_Controller_0_avalon_slave_0_agent:cp_data
	...
	wire  [97:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [19:0] lcd_reset_n_s1_agent_m0_address;                                                    // LCD_RESET_N_s1_agent:m0_address -> LCD_RESET_N_s1_translator:uav_address
	...
	wire  [98:0] lcd_reset_n_s1_agent_rf_source_data;                                                // LCD_RESET_N_s1_agent:rf_source_data -> LCD_RESET_N_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] lcd_reset_n_s1_agent_rsp_fifo_out_data;                                             // LCD_RESET_N_s1_agent_rsp_fifo:out_data -> LCD_RESET_N_s1_agent:rf_sink_data
	...
	wire         lcd_reset_n_s1_agent_rdata_fifo_src_valid;                                          // LCD_RESET_N_s1_agent:rdata_fifo_src_valid -> LCD_RESET_N_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] lcd_reset_n_s1_agent_rdata_fifo_src_data;                                           // LCD_RESET_N_s1_agent:rdata_fifo_src_data -> LCD_RESET_N_s1_agent:rdata_fifo_sink_data
	wire         lcd_reset_n_s1_agent_rdata_fifo_src_ready;                                          // LCD_RESET_N_s1_agent:rdata_fifo_sink_ready -> LCD_RESET_N_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> LCD_RESET_N_s1_agent:cp_valid
	wire  [97:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> LCD_RESET_N_s1_agent:cp_data
	...
	wire  [97:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> timer_s1_agent:cp_data
	...
	wire  [19:0] touch_panel_busy_s1_agent_m0_address;                                               // touch_panel_busy_s1_agent:m0_address -> touch_panel_busy_s1_translator:uav_address
	...
	wire  [98:0] touch_panel_busy_s1_agent_rf_source_data;                                           // touch_panel_busy_s1_agent:rf_source_data -> touch_panel_busy_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] touch_panel_busy_s1_agent_rsp_fifo_out_data;                                        // touch_panel_busy_s1_agent_rsp_fifo:out_data -> touch_panel_busy_s1_agent:rf_sink_data
	...
	wire         touch_panel_busy_s1_agent_rdata_fifo_src_valid;                                     // touch_panel_busy_s1_agent:rdata_fifo_src_valid -> touch_panel_busy_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] touch_panel_busy_s1_agent_rdata_fifo_src_data;                                      // touch_panel_busy_s1_agent:rdata_fifo_src_data -> touch_panel_busy_s1_agent:rdata_fifo_sink_data
	wire         touch_panel_busy_s1_agent_rdata_fifo_src_ready;                                     // touch_panel_busy_s1_agent:rdata_fifo_sink_ready -> touch_panel_busy_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> touch_panel_busy_s1_agent:cp_valid
	wire  [97:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> touch_panel_busy_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // touch_panel_busy_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> touch_panel_busy_s1_agent:cp_channel
	...
	wire  [19:0] touch_panel_pen_irq_n_s1_agent_m0_address;                                          // touch_panel_pen_irq_n_s1_agent:m0_address -> touch_panel_pen_irq_n_s1_translator:uav_address
	...
	wire  [98:0] touch_panel_pen_irq_n_s1_agent_rf_source_data;                                      // touch_panel_pen_irq_n_s1_agent:rf_source_data -> touch_panel_pen_irq_n_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] touch_panel_pen_irq_n_s1_agent_rsp_fifo_out_data;                                   // touch_panel_pen_irq_n_s1_agent_rsp_fifo:out_data -> touch_panel_pen_irq_n_s1_agent:rf_sink_data
	...
	wire         touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_valid;                                // touch_panel_pen_irq_n_s1_agent:rdata_fifo_src_valid -> touch_panel_pen_irq_n_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_data;                                 // touch_panel_pen_irq_n_s1_agent:rdata_fifo_src_data -> touch_panel_pen_irq_n_s1_agent:rdata_fifo_sink_data
	wire         touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_ready;                                // touch_panel_pen_irq_n_s1_agent:rdata_fifo_sink_ready -> touch_panel_pen_irq_n_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> touch_panel_pen_irq_n_s1_agent:cp_valid
	wire  [97:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> touch_panel_pen_irq_n_s1_agent:cp_data
	...
	wire  [19:0] touch_panel_spi_spi_control_port_agent_m0_address;                                  // touch_panel_spi_spi_control_port_agent:m0_address -> touch_panel_spi_spi_control_port_translator:uav_address
	...
	wire  [98:0] touch_panel_spi_spi_control_port_agent_rf_source_data;                              // touch_panel_spi_spi_control_port_agent:rf_source_data -> touch_panel_spi_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [98:0] touch_panel_spi_spi_control_port_agent_rsp_fifo_out_data;                           // touch_panel_spi_spi_control_port_agent_rsp_fifo:out_data -> touch_panel_spi_spi_control_port_agent:rf_sink_data
	...
	wire         touch_panel_spi_spi_control_port_agent_rdata_fifo_src_valid;                        // touch_panel_spi_spi_control_port_agent:rdata_fifo_src_valid -> touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] touch_panel_spi_spi_control_port_agent_rdata_fifo_src_data;                         // touch_panel_spi_spi_control_port_agent:rdata_fifo_src_data -> touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_data
	wire         touch_panel_spi_spi_control_port_agent_rdata_fifo_src_ready;                        // touch_panel_spi_spi_control_port_agent:rdata_fifo_sink_ready -> touch_panel_spi_spi_control_port_agent:rdata_fifo_src_ready
	wire         cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> touch_panel_spi_spi_control_port_agent:cp_valid
	wire  [97:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> touch_panel_spi_spi_control_port_agent:cp_data
	...
	wire  [97:0] lt24_controller_0_avalon_slave_0_agent_rp_data;                                     // LT24_Controller_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [97:0] onchip_memory_s1_agent_rp_data;                                                     // onchip_memory_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [97:0] lcd_reset_n_s1_agent_rp_data;                                                       // LCD_RESET_N_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [97:0] timer_s1_agent_rp_data;                                                             // timer_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [97:0] touch_panel_busy_s1_agent_rp_data;                                                  // touch_panel_busy_s1_agent:rp_data -> router_009:sink_data
	...
	wire         touch_panel_pen_irq_n_s1_agent_rp_valid;                                            // touch_panel_pen_irq_n_s1_agent:rp_valid -> router_010:sink_valid
	wire  [97:0] touch_panel_pen_irq_n_s1_agent_rp_data;                                             // touch_panel_pen_irq_n_s1_agent:rp_data -> router_010:sink_data
	wire         touch_panel_pen_irq_n_s1_agent_rp_ready;                                            // router_010:sink_ready -> touch_panel_pen_irq_n_s1_agent:rp_ready
	wire         touch_panel_pen_irq_n_s1_agent_rp_startofpacket;                                    // touch_panel_pen_irq_n_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         touch_panel_pen_irq_n_s1_agent_rp_endofpacket;                                      // touch_panel_pen_irq_n_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [97:0] key_s1_agent_rp_data;                                                               // key_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [97:0] touch_panel_spi_spi_control_port_agent_rp_data;                                     // touch_panel_spi_spi_control_port_agent:rp_data -> router_012:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (lt24_controller_0_avalon_slave_0_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (lcd_reset_n_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (lcd_reset_n_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (lcd_reset_n_s1_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (touch_panel_busy_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (touch_panel_busy_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (touch_panel_busy_s1_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (touch_panel_pen_irq_n_s1_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (touch_panel_spi_spi_control_port_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (touch_panel_spi_spi_control_port_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (touch_panel_spi_spi_control_port_agent_rdata_fifo_src_data),        //                .data
	...
	lt24_qsys_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (alt_pll_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lt24_qsys_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (alt_pll_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
